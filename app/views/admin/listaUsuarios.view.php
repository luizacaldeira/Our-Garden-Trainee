...
<head>
    ...
    <link rel="stylesheet" href="../../../public/css/modalAddNewUser.css">
    <link rel="stylesheet" href="../../../public/css/modalViewUser.css">
    <link rel="stylesheet" href="/public/css/modalEdituser.css">
    <link rel="stylesheet" href="/public/css/modalDeletUser.css">
    ...
    <div class="background-complete-page">
        <main>
            ...
            <section class="section3">
                <div class="usersTablePagination">
            ...
            <section class="modalAddNewUser" id="modalAddNewUser">
                ...
                <div class="modalAddNewUserMain">
                    <form class="addNewUserForm" id="addNewUserForm" method="post" action="usuarios/criar">
                        ...
                        <section class="bottonsAddUser">
                            <button class="btnCancelNewUser" id="btnCancelNewUser" type="button"
                                onclick="fecharModal('modalAddNewUser', 'fundoJS')">Cancelar</button>
                            <button class="btnAddNewUser" id="btnAddNewUser" type="submit">Adicionar</button>
                        </section>
                    </form>
                </div>
            </section>
